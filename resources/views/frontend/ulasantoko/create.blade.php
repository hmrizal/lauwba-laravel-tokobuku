...
<body>
            ...
            <div class="row">
                <div class="contact-info col-lg-6 pb-3">
                    ...
                    <div class="contact-address padding-xlarge">
                        ...
                        @if (Auth::check())
                            <a href="/ulasantoko/create" class="btn btn-dark me-2 mb-1">Review our store</a>
                        @else
                ...
                <div class="inquiry-item col-lg-6">
                    ...
                    <form id="form" action="/backend/mailbox/store" method="post">
                        ...
                        <div class="py-3">
                            ...
                            <input type="text" name="nama" placeholder="Write your name here" class="w-100"
                                required>
                        </div>
                        <div class="py-3">
    ...
    <hr>
    <section id="our-stores" class="padding-small">
        <div class="container">
            <div class="row">
                <div class="add-review margin-small">
                    <h3>Add a review</h3>
                    <p>Required fields are marked *</p>
                    <form id="form" action="/backend/ulasantoko/store" method="POST">
                        @csrf
                        <div class="py-3">
                            <label>Your Name</label>
                        ...
                        <div class="py-3">
                            ...
                            <textarea placeholder="Write your review here" class="w-100" cols=50 rows=8 name="ulasan"></textarea>
                        </div>
                        <button type="submit" name="submit" class="btn btn-dark w-100 my-3">Submit</button>
                    </form>
                </div>
